function const_wind_high()
    ...
    Windgeschwindigkeit             = 14;  % Konstante Windgeschw., wenn Windtyp = 1 ausgewählt wurde
    ...
    filename = fullfile('./5. Validierung/3. Reglervalidierung/const_wind_high.pdf');
