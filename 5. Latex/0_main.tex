...
\begin{acronym}[Symbols]
    ...
    % B
    \acro{bflug}    [$b_{\mathrm{Flug}}$]       {Breite eines Tragflügels}
    
    % C
    \acro{c}        [$c$]                       {Anströmgeschwindigkeit}
    \acro{cA}       [$c_{\mathrm{A}}$]          {Auftriebsbeiwert}
    ...
    \acro{cW}       [$c_{\mathrm{W}}$]          {Widerstandsbeiwert}
    ...
    \acro{mdot3}    [$\dot{m}_{\mathrm{3}}$]    {Luftmassenstrom an Stelle 3} \acro{MB}       [$M_{\mathrm{B}}$]          {Blattdrehmoment}   
    \acro{MG}       [$M_{\mathrm{G}}$]          {Generatordrehmoment}
    \acro{MG1}      [$M_{\mathrm{G,I}}$]        {Generatordrehmoment unterer Teillastbereich}
    \acro{MG2}      [$M_{\mathrm{G,II}}$]       {Generatordrehmoment oberer Teillastbereich}
    \acro{MGnenn}   [$M_{\mathrm{G,nenn}}$]     {Generatornenndrehmoment}
    \acro{MGsoll}   [$M_{\mathrm{G,soll}}$]     {Generatorsolldrehmoment}
    \acro{MR}       [$M_{\mathrm{R}}$]          {Rotordrehmoment}
    \acro{MW}       [$M_{\mathrm{W}}$]          {\glqq Wind\grqq{}-drehmoment}
    
    % N
    \acro{ng}       [$n_{\mathrm{g}}$]          {Getriebeübersetzung}
    \acro{nG}       [$n_{\mathrm{G}}$]          {Generatordrehzahl}
    \acro{nGNenn}   [$n_{\mathrm{G,nenn}}$]     {Generatornenndrehzahl}
    \acro{nR}       [$n_{\mathrm{R}}$]          {Rotordrehzahl}
    
    % P
    \acro{PG}       [$P_{\mathrm{G}}$]          {Generatorleistung}
    \acro{PGNenn}   [$P_{\mathrm{G,nenn}}$]     {Generatornennleistung}
    ...
    \acro{vkrit}    [$v_{\mathrm{1,krit}}$]     {kritische Windgeschwindigkeit}
    ...
    % THETA
    \acro{theta}    [$\theta$]                  {Pitchwinkel}
    \acro{theta3}   [$\theta_{\mathrm{III}}$]   {Pitchwinkel Volllastbereich}
    \acro{thetasoll}[$\theta_{\mathrm{soll}}$]  {Soll-Pitchwinkel}
    ...
    % PHI
    \acro{phiG}     [$\varphi_{\mathrm{G}}$]    {Generatorwinkel}
    \acro{phiR}     [$\varphi_{\mathrm{R}}$]    {Rotorwinkel}
    \acro{dotphiG}  [$\dot\varphi_{\mathrm{G}}$]{Generatorwinkelgeschwindigkeit}
    \acro{dotphiR}  [$\dot\varphi_{\mathrm{R}}$]{Rotorwinkelgeschwindigkeit}
    \acro{phiRtilde}[$\tilde{\varphi}_{\mathrm{R}}$]    {Rotorwinkel bezogen auf die Generatorseite des Getriebes}
    ...
    \acro{omegaRist}[$\omega_{\mathrm{R,ist}}$] {Ist-Wert der Ro\-tor\-win\-kel\-ge\-schwin\-dig\-keit}
